...
class DynamicOperateStepSuite extends TestSuitBase with Logging {
  ...
  test("DynamicOperate test example") {
    ...
    val expectedOutput = Seq(Seq(Array.apply((table+".NTcount","190"),(table+".Fee","1061"))), Seq(Array.apply((table+".NTcount","133"),(table+".Fee","1011"))), Seq(Array.apply((table+".NTcount","131"),(table+".Fee","1001"))))
